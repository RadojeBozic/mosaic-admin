<div class="flex flex-col col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
    <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 class="font-semibold text-gray-800 dark:text-gray-100">{{ __('ui.analytics') }}</h2>
    </header>
    <div class="px-5 py-1">
        <div class="flex flex-wrap max-sm:*:w-1/2">
            <div class="flex items-center py-2">
                <div class="mr-5">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ __('ui.unique_visitors') }}</div>
                </div>
            ...
            <div class="flex items-center py-2">
                <div class="mr-5">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ __('ui.pageviews') }}</div>
                </div>
                <div class="hidden md:block w-px h-8 bg-gray-200 dark:bg-gray-700 mr-5" aria-hidden="true"></div>
            </div>
            <div class="flex items-center py-2">
                <div class="mr-5">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ __('ui.bounce_rate') }}</div>
                </div>
                <div class="hidden md:block w-px h-8 bg-gray-200 dark:bg-gray-700 mr-5" aria-hidden="true"></div>
            </div>
            <div class="flex items-center">
                <div>
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ __('ui.visit_duration') }}</div>
                </div>
            </div>
        </div>
    </div>
