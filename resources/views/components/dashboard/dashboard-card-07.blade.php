        ...
        <div class="overflow-x-auto">
            <table class="table-auto w-full dark:text-gray-300">
                ...
                <thead class="text-xs uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/50 rounded-xs">
                    <tr>
                        <th class="p-2">
                            <div class="font-semibold text-left">{{ __('ui.source') }}</div>
                        </th>
                        <th class="p-2">
                            <div class="font-semibold text-center">{{ __('ui.visitors') }}</div>
                        </th>
                        <th class="p-2">
                            <div class="font-semibold text-center">{{ __('ui.revenues') }}</div>
                        </th>
                        <th class="p-2">
                            <div class="font-semibold text-center">{{ __('ui.sales') }}</div>
                        </th>
                        <th class="p-2">
                            <div class="font-semibold text-center">{{ __('ui.conversion') }}</div>
                        </th>
                    </tr>
                </thead>
                <!-- Table body -->
